  ...
  return (
    <div className="bg-gray-100  dark:bg-gray-900">
      ...
      <div className="bg-gray-200 grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-x-20  dark:bg-gray-800 ">
        {<CardSumary icon={UsersRound} title="Total Pokémones" total={totalPokemons ? totalPokemons : <Spiner/>}/>}
        {<CardSumary icon={User} title="Tipos de Pokémones" total={ totalTypes ? totalTypes : <Spiner/>} />}
        {<CardSumary icon={ChartColumn} title="Generaciones" total={totalGenerations ? totalGenerations :<Spiner/>} />}
        {<CardSumary icon={CalendarFold} title="Fecha actual" total={new Date().toLocaleDateString()} />}
